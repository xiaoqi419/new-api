...
import UserIpsModal from './modals/UserIpsModal';
...
const UsersTable = (usersData) => {
  ...
  const columns = useMemo(() => {
    return getUsersColumns({
      ...
      showUserIpsModal: showUserIpsUserModal,
    });
  }, [
    t,
    setEditingUser,
  ...
  return (
    <>
      ...
      <UserIpsModal
        visible={showUserIpsModal}
        onCancel={() => setShowUserIpsModal(false)}
        user={modalUser}
      />
    </>
  );
