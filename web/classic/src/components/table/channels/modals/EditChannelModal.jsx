  ...
  const loadChannel = async () => {
    ...
    if (success) {
      ...
      setChannelSettings({
        ...
        volc_asset_ak: data.volc_asset_ak || '',
        volc_asset_sk: data.volc_asset_sk || '',
        volc_project_name: data.volc_project_name || '',
      });
              ...
              <div className='space-y-4'>
                ...
                <div className='pt-3'>
                  ...
                  <Form.Switch
                    ...
                    uncheckedText={t('关')}
                    onChange={(value) =>
                      handleChannelSettingsChange('fallback', value)
                    }
                    extraText={t(
                  ...
                  {inputs.type === 54 && (
                    <>
                      <Form.Input
                        field='volc_asset_ak'
                        label={t('火山素材库 AccessKey')}
                        placeholder={t('私域素材库 AK/SK 签名所需')}
                        onChange={(value) =>
                          handleChannelSettingsChange('volc_asset_ak', value)
                        }
                        showClear
                        extraText={t(
                          '火山私域素材库（虚拟人像）专用，与视频共用本渠道；素材库不能用 Ark API Key，必须 AK/SK 签名',
                        )}
                      />
                      <Form.Input
                        field='volc_asset_sk'
                        label={t('火山素材库 SecretKey')}
                        mode='password'
                        placeholder={t('私域素材库 AK/SK 签名所需')}
                        onChange={(value) =>
                          handleChannelSettingsChange('volc_asset_sk', value)
                        }
                        showClear
                      />
                      <Form.Input
                        field='volc_project_name'
                        label={t('火山项目名 ProjectName')}
                        placeholder='default'
                        onChange={(value) =>
                          handleChannelSettingsChange(
                            'volc_project_name',
                        ...
                        showClear
                        extraText={t('素材归属的火山项目，留空默认 default')}
                      />
                    </>
                  )}
                </div>
