  ...
  return (
    <div className='space-y-4 pt-4'>
      ...
      <div className='grid min-w-0 gap-x-5 gap-y-4 lg:grid-cols-2'>
        ...
        <div className='bg-chart-1/8 text-foreground rounded-md p-4 text-sm lg:col-span-2'>
          <p className='mb-2 font-medium'>{t('Webhook Configuration:')}</p>
          <ul className='list-inside list-disc space-y-1'>
            <li>
              {t('Webhook URL (Test):')}{' '}
              <code className='bg-chart-1/15 rounded px-1 py-0.5 text-xs'>
        ...
        */}
        <div className='space-y-4 pt-2 lg:col-span-2'>
          ...
          {/*
            ...
            */}
          <div className='border-chart-1/25 bg-chart-1/8 text-foreground rounded-md border p-3 text-xs'>
