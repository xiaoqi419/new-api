...
function AppChip({
  ...
  return (
    <a
      ...
      className={`flex max-w-full min-w-0 items-center gap-2 rounded-full border border-black/[0.14] bg-black/[0.04] px-[18px] py-2 text-[13px] font-semibold text-[#050505] transition-colors duration-200 hover:bg-black/[0.08] dark:border-white/[0.14] dark:bg-white/[0.06] dark:text-white dark:hover:bg-white/[0.1] ${compactDesktop ? 'xl:gap-1.5 xl:px-3 xl:text-xs' : ''}`}
    >
      {app.iconUrl ? (
        <img
          src={app.iconUrl}
      ...
      <div className='relative z-10 xl:mx-auto xl:h-[897px] xl:w-full xl:max-w-[1392px] xl:px-[54px] xl:pt-[138px]'>
        ...
        <div className='relative grid items-start lg:grid-cols-[minmax(0,590px)_402px] lg:justify-between'>
          <div className='max-w-[590px]'>
            ...
            <h1
              className='landing-animate-fade-up text-[clamp(3rem,6vw,4.5rem)] leading-[1.06] font-black tracking-normal md:text-[72px] md:leading-[76px] lg:min-h-[210px] lg:w-[590px] lg:max-w-full lg:leading-[70px]'
            ...
            <p
              className={`landing-animate-fade-up mt-8 max-w-[575px] text-[17px] leading-[1.65] text-[#575757] lg:mt-[24px] lg:ml-[2px] lg:min-h-[70px] lg:text-[19px] lg:leading-[31px] dark:text-[#bcbcbc] ${compactEnglishDesktop ? 'xl:mt-[18px] xl:max-w-[360px] xl:text-[17px] xl:leading-[27px]' : ''}`}
            ...
            <div
              ...
              className={`landing-animate-fade-up mt-9 flex flex-wrap items-center gap-3 lg:mt-[24px] ${compactEnglishDesktop ? 'xl:mt-[18px]' : ''}`}
            ...
            <div
              data-testid='home-hero-supported-apps'
              className={`landing-animate-fade-up mt-12 max-w-full min-w-0 lg:mt-[24px] lg:ml-[2px] ${compactEnglishDesktop ? 'xl:mt-[18px] xl:max-w-[360px]' : ''}`}
            ...
            >
              ...
              <p
                className={`max-w-[420px] text-[14px] leading-6 text-[#575757] lg:leading-[23px] dark:text-[#a8a8a8] ${compactEnglishDesktop ? 'xl:max-w-[350px]' : ''}`}
              >
              ...
              <div
                data-testid='home-hero-app-chips'
                className={`mt-4 flex max-w-full min-w-0 flex-wrap gap-3 lg:mt-5 lg:gap-3 ${compactEnglishDesktop ? 'xl:mt-3 xl:flex-nowrap xl:gap-2' : ''}`}
              >
                {content?.apps ? (
                  content.apps.map((app) => (
                    <AppChip
                      key={app.name}
                      app={app}
                      compactDesktop={compactEnglishDesktop}
                    />
                  ))
                ) : (
                  <>
                    <a
                      ...
                      target='_blank'
                      rel='noopener noreferrer'
                      className={`flex max-w-full min-w-0 items-center gap-2 rounded-full border border-black/[0.14] bg-black/[0.04] px-[18px] py-2 text-[13px] font-semibold text-[#050505] transition-colors duration-200 hover:bg-black/[0.08] dark:border-white/[0.14] dark:bg-white/[0.06] dark:text-white dark:hover:bg-white/[0.1] ${compactEnglishDesktop ? 'xl:gap-1.5 xl:px-3 xl:text-xs' : ''}`}
                    >
                      <CherryStudio.Color size={15} className='shrink-0' />
                      <span className='min-w-0 truncate'>Cherry Studio</span>
                    </a>
                    <AppChip
                      app={{
                        name: 'CC Switch',
