  ...
  return (
    ...
    >
      ...
      <span
        ...
        className='bg-primary/10 text-primary size-6 shrink-0 items-center justify-center rounded-md text-[10px] font-bold uppercase'
      >
        {app.name.slice(0, 2)}
      </span>
      <span>{app.name}</span>
      ...
      <div
        ...
        style={{
          background: [
            ...
            'radial-gradient(ellipse 40% 35% at 40% 80%, color-mix(in oklch, var(--chart-4) 40%, transparent) 0%, transparent 70%)',
          ].join(', '),
        }}
      />
      {/* Grid pattern */}
      ...
      <div className='mx-auto grid max-w-6xl grid-cols-1 items-start gap-12 lg:grid-cols-12 lg:gap-8'>
        ...
        <div className='flex flex-col items-start text-left lg:col-span-6'>
          ...
          >
            ...
            <br />
            <span className='from-chart-1 via-chart-4 to-primary bg-gradient-to-r bg-clip-text text-transparent'>
