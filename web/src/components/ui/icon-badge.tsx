  ...
  'flex shrink-0 items-center justify-center [&>svg]:shrink-0',
  {
    variants: {
      tone: {
        ...
        'chart-1': 'bg-chart-1/10 text-tag-1',
        'chart-2': 'bg-chart-2/10 text-tag-2',
        'chart-3': 'bg-chart-3/10 text-tag-3',
        'chart-4': 'bg-chart-4/10 text-tag-4',
        'chart-5': 'bg-chart-5/10 text-tag-5',
      },
      size: {
