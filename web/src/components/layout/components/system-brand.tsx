  ...
  if (variant === 'inline') {
    return (
      <Link
        ...
        className={cn(
          'text-foreground inline-flex h-9 items-center gap-2 rounded-md px-2 text-lg font-bold transition-colors outline-none select-none',
      ...
      >
        ...
        <span className='max-w-[12rem] truncate tracking-tight'>{name}</span>
      </Link>
    )
  }
