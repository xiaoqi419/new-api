...
> 3. 微信订阅号验证码登录
>
> 文档同时给出与 new-api 现有架构结合的落地设计、数据模型、接口、配置项、分阶段开发计划与风险前提。本文是早期设计基线；实际实施进度以 [Torch AI 维护状态](torch-ai-maintenance-status.md)、Git 历史和 Comet Archive 为准。
...
- 下一个工程目标为 Phase 4 质量门禁、关键路径回归、i18n 检查和发布前风险清单。
