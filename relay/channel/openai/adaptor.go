...
func (a *Adaptor) ConvertOpenAIRequest(c *gin.Context, info *relaycommon.RelayInfo, request *dto.GeneralOpenAIRequest) (any, error) {
	...
	preserveSuffix := info.ChannelSetting.ReasoningEffortToModelSuffix || model_setting.ShouldPreserveThinkingSuffix(info.OriginModelName) || model_setting.ShouldPreserveThinkingSuffix(info.UpstreamModelName)
...
func (a *Adaptor) ConvertOpenAIResponsesRequest(c *gin.Context, info *relaycommon.RelayInfo, request dto.OpenAIResponsesRequest) (any, error) {
	...
	preserveSuffix := model_setting.ShouldPreserveThinkingSuffix(request.Model) || (info != nil && ((info.ChannelMeta != nil && info.ChannelSetting.ReasoningEffortToModelSuffix) || model_setting.ShouldPreserveThinkingSuffix(info.OriginModelName)))
	if preserveSuffix {
		effort = ""
	}
	originEffort := ""
