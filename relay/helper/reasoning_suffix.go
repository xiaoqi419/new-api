...
// NewReasoningModelAPIError preserves the client-facing status for malformed
// model modifiers while retaining the existing channel-mapping error contract
// for unexpected helper failures.
func NewReasoningModelAPIError(err error) *types.NewAPIError {
